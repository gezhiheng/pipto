...
export async function getPicFill(type: any, node: any, warpObj: any) {
  if (!node) return ''
...
export function getBgGradientFill(bgPr: any, phClr: any, slideMasterContent: any, warpObj: any) {
  if (bgPr) {
...
export async function getSlideBackgroundFill(warpObj: any) {
...
async function findFillInGroupHierarchy(groupHierarchy: any, warpObj: any, source: any) {
...
export function getSolidFill(solidFill: any, clrMap: any, phClr: any, warpObj: any) {
  if (!solidFill) return ''
